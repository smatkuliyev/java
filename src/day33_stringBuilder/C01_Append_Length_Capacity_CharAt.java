...
public class C01_Append_Length_Capacity_CharAt {

	public static void main(String[] args) {
		
		StringBuilder sb = new StringBuilder();
		
		System.out.println(sb.length()); 		// 0, sb'in kullanilan uzunlugunu verir
		...
		sb.append("anlasýldý mi", 3, 6);
		System.out.println(sb); 					// Java candirasý
