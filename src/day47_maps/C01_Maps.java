...
public class C01_Maps {
	...
	public static void main(String[] args) {
		// Bir map olusturmadan once, Map'e koyacaðimiz Key ve Value degerlerini incelemeliyiz
		// Tum degerleri koyabilmek icin Key ve Value icin Object, Object secebiliriz.
		// Ama durumda map icerisindeki elemanlara ait bilgileri ulasmakta zorlanabiliriz
		// Date turunu secerken hem icine koyacagimiz tum elemanlari kapsayacak bir data turu secmeliyiz
		...
		System.out.println(sinif.keySet()); 				// [101, 102, 103, 104]   bir set olarak key degerlerini donduruyor
