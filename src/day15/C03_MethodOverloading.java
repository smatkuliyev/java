...
public class C03_MethodOverloading {
	...
	public static void main(String[] args) {
		...
		// Ayni isimde birden fazla method olursa Java hangisini calistiracagini nasil karar verir
		// Ismi ayni olan methodlarda oncelikle parametre sayisina bakar
		...
		// tamamen uyusan yoksa kapsayan var mi diye bakar ve onu kullanir
